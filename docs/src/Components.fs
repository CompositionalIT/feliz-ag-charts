...
type Plot = { Quarter: string; Petrol: int; Diesel: int }
                ...
                prop.children [
                    Html.div [
                        StyledComponents.Description
                            "Feliz.AgChart"
                            "ag-charts-react"
                            { Name = "nuget"; Link = "https://www.nuget.org/packages/Feliz.AgChart/" }
                            { Name = "npm"; Link = "https://www.npmjs.com/package/ag-charts-react" }
                        ...
                        StyledComponents.HeadingWithContent
                            ...
                            (Html.div [
                                AgChart.chart [
                                    AgChart.options [
                                        AgChart.data data
                                        AgChart.title "Fuel Spending (2019)"
                                        AgChart.height 500
                                        AgChart.width 1000
                                        AgChart.series [
                                            Series.create [
